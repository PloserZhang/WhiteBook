            ...
            var clazz = (function(ProtoBuf, T) {
                ...
                function cloneRaw(obj, binaryAsBase64, longsAsStrings, resolvedType) {
                    ...
                    if (ProtoBuf.Long.isLong(obj)){
                        //HACKED: convert long by a function if it's
                        return  (typeof longsAsStrings ==='function')? longsAsStrings(obj) :  (longsAsStrings ? obj.toString() : ProtoBuf.Long.fromValue(obj));
                    }
                    var clone;
                    // Clone arrays
                 ...
                 * @param {boolean} longsAsStrings Whether to encode longs as strings HACKED:xxxxxx, default to 
                 * @returns {Object.<string,*>} Raw payload
                 * @expose
                 */
                MessagePrototype.toRaw = function(binaryAsBase64, longsAsStrings) {
                    return cloneRaw(this, !!binaryAsBase64, typeof longsAsStrings==="undefined" ? Number : !!longsAsStrings, this.$type);
                };
